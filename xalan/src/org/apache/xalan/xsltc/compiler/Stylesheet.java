...
public final class Stylesheet extends SyntaxTreeNode {
	...
	while (elements.hasMoreElements()) {
	    ...
	    assert (child instanceof org.apache.xalan.xsltc.compiler.Template||(!(child instanceof org.apache.xalan.xsltc.compiler.Stylesheet)&& child instanceof org.apache.xalan.xsltc.compiler.AbsolutePathPattern));
	...
	*/
    ...
    for (int i = 0; i < count; i++) {
        ...
        assert (TitledBorder instanceof org.apache.xalan.xsltc.compiler.VariableBase|| tle instanceof org.apache.xalan.xsltc.compiler.Util.ClassGenerator);
