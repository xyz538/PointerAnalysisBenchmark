                        ...
                        if (childChunkCount > 0) {
                            ...
                            for (int i = 0; i < childChunkCount; i++) {
                                ...
                                InstructionHandle end =
                                    (InstructionHandle) nestedSubChunks
                                                            .get(i*2+1);
                                assert(end == null||end instanceof org.apache.bcel.generic.InstructionHandle)&&!(EndDocument instanceof org.apache.xalan.xsltc.compiler.util.MethodGenerator$Chunk);                               
