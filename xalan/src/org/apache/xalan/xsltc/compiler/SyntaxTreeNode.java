...
public abstract class SyntaxTreeNode implements Constants {
	...
	if (node instanceof Variable) {
		assert (node == null || node instanceof org.apache.xalan.xsltc.compiler.SyntaxTreeNode)&&!(node instanceof org.apache.xalan.xsltc.compiler.AbsolutePathPattern);
    ...
    protected void translateContents(ClassGenerator classGen,
        ...
        for (int i = 0; i < n; i++) {
            ...
            assert(item==null||item instanceof org.apache.xalan.xsltc.compiler.SyntaxTreeNode)&&!(item instanceof org.apache.xalan.xsltc.compiler.AbsolutePathPattern);
