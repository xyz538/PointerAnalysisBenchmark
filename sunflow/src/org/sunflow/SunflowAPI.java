...
public class SunflowAPI {
    ...
    public final void parameter(String name, Color value) {
    	assert(value==null||value instanceof org.sunflow.image.Color);
    ...
    public final void parameter(String name, Vector3 value) {
    	assert(value==null||value instanceof org.sunflow.math.Vector3);
    ...
    public final void parameter(String name, Matrix4 value) {
    	assert(value==null||value instanceof org.sunflow.math.Matrix4);
     ...
     */
    public final void parameter(String name, int[] value) {
    	assert(value ==null ||value instanceof int[]);
     ...
     */
    public final void parameter(String name, String[] value) {
    	assert(value ==null ||value instanceof java.lang.String[]);
    ...
    public final void shader(String name, Shader shader) {
        if (shader != null) {
            ...
            assert(shader==null||shader instanceof org.sunflow.core.Shader);
