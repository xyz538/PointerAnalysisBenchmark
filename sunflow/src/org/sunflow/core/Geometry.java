...
public class Geometry implements RenderObject {
    ...
    int getNumPrimitives() {
    	assert(primitives instanceof org.sunflow.core.primitive.Sphere||primitives instanceof org.sunflow.core.primitive.TriangleMesh||primitives instanceof org.sunflow.core.light.TriangleMeshLight&&!(primitives instanceof org.sunflow.core.primitive.QuadMesh));
    ...
    PrimitiveList getBakingPrimitives() {
        ...
        if (primitives == null)
            return null;
        assert(primitives instanceof org.sunflow.core.primitive.Sphere||primitives instanceof org.sunflow.core.primitive.TriangleMesh||primitives instanceof org.sunflow.core.light.TriangleMeshLight&&!(primitives instanceof org.sunflow.core.primitive.QuadMesh));
        primitives.getBakingPrimitives();
    }
