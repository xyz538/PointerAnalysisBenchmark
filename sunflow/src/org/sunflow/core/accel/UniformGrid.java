...
public final class UniformGrid implements AccelerationStructure {
    ...
    public void build(PrimitiveList primitives) {
        Timer t = new Timer();
        t.start();
        assert((primitives instanceof org.sunflow.core.InstanceList)||(primitives instanceof org.sunflow.core.primitive.TriangleMesh));
        assert!(primitives instanceof org.sunflow.core.primitive.Sphere);
