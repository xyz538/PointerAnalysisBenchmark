...
public class KDTree implements AccelerationStructure {
    ...
    public void build(PrimitiveList primitives) {
        ...
        total.start();
        assert(primitiveList instanceof org.sunflow.core.InstanceList|| primitiveList instanceof org.sunflow.core.primitive.TriangleMesh);
