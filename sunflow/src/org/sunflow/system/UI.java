...
public final class UI {
    ...
    public final static void set(UserInterface ui) {
        ...
        assert(ui instanceof org.sunflow.Benchmark)&&!(ui instanceof org.sunflow.system.ui.SilentInterface);
        UI.ui = ui;
    }
    ...
    public final static synchronized void printDetailed(Module m, String s, Object... args) {
        if (verbosity > 3)
        	assert(ui instanceof org.sunflow.system.ui.ConsoleInterface ||ui instanceof org.sunflow.Benchmark)&&!(ui instanceof org.sunflow.system.ui.SilentInterface);
